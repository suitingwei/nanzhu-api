...
<img src="http://nanzhu.oss-cn-shanghai.aliyuncs.com/pictures/1144302390.jpg">
...
<script>
    ...
    wx.ready(function () {
        wx.onMenuShareTimeline({
            title: "南竹通告单参考大计划、每日通告单、预备通告单使用说明",
            link: "https://apiv2.nanzhuxinyu.com/help/plan.php",
            imgUrl: "http://nanzhu.oss-cn-shanghai.aliyuncs.com/pictures/logo-lg.png",
        });
        wx.onMenuShareAppMessage({
            title: "南竹通告单参考大计划、每日通告单、预备通告单使用说明",
            desc: "南竹通告单\n参考大计划、每日通告单、预备通告单使用说明",
            link: "https://apiv2.nanzhuxinyu.com/help/plan.php",
            imgUrl: "http://nanzhu.oss-cn-shanghai.aliyuncs.com/pictures/logo-lg.png",
            type: 'link',
        });
