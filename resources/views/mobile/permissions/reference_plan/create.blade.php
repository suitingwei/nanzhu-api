...
<div class="contact ui-content">
    <div id='list' class="mui-indexed-list">
        ...
        <div class="mui-indexed-list-inner">
            ...
            <form id="addReceivePowerForm" action="/mobile/permissions/reference-plan/" method="post">
                        ...
                        @foreach($users as $user)
                            <li data-value="ALM" data-tags="{{ $user->FNAME }}"
                                ...
                                <input class="active-op" name="subBox" type="checkbox"
                                       user-id="{{ $user->FID }}"
                                       @if($user->hadAssignedPowerInMovie($movieId,\App\Models\ReferencePlanPower::class) )
                                       checked
                                        @endif>
                                <input type="hidden" name="reference_plan_powers[]">
                                <a class="active-info">
                                    <span class="pic">
