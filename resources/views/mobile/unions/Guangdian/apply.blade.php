    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" action="/mobile/unions/postapply" method="post" enctype='multipart/form-data'>
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group" style="margin-bottom: 0">
                        ...
                        <div class="col-lg-8">
                            <input id="title" type="text" name="title" class="form-control" placeholder="项目类型及题材" required>
                            <input id='tempName' type="text" name="tempName" class="form-control" placeholder="暂定名" required>
                            <input id="time" type="text" name="time" class="form-control" placeholder="预计开机日期" required>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">故事梗概</label>
                        <input type="hidden" name="content" id="forContent">

                        <div class="col-lg-8">
                            <textarea id="editor" rows="5" class="form-control" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">其他说明</label>
                        <input type="hidden" name="others" id="forother" >

                        <div class="col-lg-8">
                            <textarea id="else" class="form-control" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-8">
                            <button type="submit" class="btn mui-btn-success" id="save">保存</button>
                        </div>
                    </div>
                </form>
