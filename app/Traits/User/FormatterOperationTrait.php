...
trait FormatterOperationTrait
{
     ...
     * 添加用户的艺人资料信息
     */
    public function withProfileInfo()
    {
    ...
    /**
     * Add info about service man.
     */
    public function withServiceInfo()
    {
        $this->obj->can_delete     = $this->FID != env('MOVIE_CLOTHES_SERVER_USER_ID');
        $this->obj->can_black      = $this->FID != env('MOVIE_CLOTHES_SERVER_USER_ID');
        $this->obj->can_join_group = $this->FID != env('MOVIE_CLOTHES_SERVER_USER_ID');
        return $this;
    }
}
