...
class PingPPUtil
{
    ...
    /**
     * Get the chinese payment channel for the chinese.
     *
     * @param $channel
     *
     * @return mixed|string
     */
    public static function transforPaymentChannel($channel)
    {
        if (isset(static::$paymenChannel[$channel])) {
            return static::$paymenChannel[$channel];
        }
