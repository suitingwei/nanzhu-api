...
//        }
        ...
        $movieName = $this->movie ? $this->movie->FNAME : '';

        return "{$this->FNAME}《{$movieName}》";
    }
     ...
     * @param $userId
     */
    public function addUserToShareTodos($userId)
    {
        $departmentTodos = $this->shareTodos();
    ...
    /**
     * Judge wheather the group is the tongchou group.
     * @return boolean
     */
    public function isTongChou()
    {
        return $this->FGROUPTYPE == static::TYPE_TONG_CHOU;
    }

    /**
     * Judge whether the group is the changji group.
     * @return bool
     */
    public function isChangJi()
    {
        return $this->FGROUPTYPE == static::TYPE_CHANGJI;
    }
